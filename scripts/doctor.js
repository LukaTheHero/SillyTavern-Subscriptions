...
try {
    ...
    console.log(`     API key: ${c.api?.available ? `${c.api.source} → ${c.api.baseUrl}` : 'none'}`);
    ...
    console.log(`     API key: ${x.api?.available ? `${x.api.source} → ${x.api.baseUrl}` : 'none'}`);
    ...
    console.log(`     API key: ${g.api?.available ? `${g.api.source} → ${g.api.baseUrl}` : 'none'}`);
